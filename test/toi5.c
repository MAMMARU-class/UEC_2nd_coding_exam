...
int main(void){
    ...
    // format
    fourier_format_pointsfile("data/toi5_f1.csv", SIZE_POINT, SIZE_POINT, y_vector_s1, coef_mat_s1);
	fourier_format_pointsfile("data/toi5_f2.csv", SIZE_POINT, SIZE_POINT, y_vector_s2, coef_mat_s2);
